...
export default function DoctorSearchSelect({ onSelect, selectedDoctor }) {
  ...
  const handleCreate = async () => {
    const created = await base44.entities.Doctor.create({
      full_name: newDoctor.full_name.toUpperCase(),
      license: newDoctor.license.toUpperCase(),
      specialty: newDoctor.specialty.toUpperCase(),
      institution: newDoctor.institution.toUpperCase(),
    });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Cédula: {selectedDoctor.license}
              {selectedDoctor.specialty ? ` · ${selectedDoctor.specialty}` : ""}
              {selectedDoctor.institution ? ` · ${selectedDoctor.institution}` : ""}
            </p>
          </div>
        </div>
          ...
          {filtered.length === 0 ? (
            ...
            filtered.map(d => (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  Cédula: {d.license}{d.specialty ? ` · ${d.specialty}` : ""}
                </p>
              </button>
            ))
          )}
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={e => setNewDoctor(p => ({ ...p, license: e.target.value }))}
            ...
            <div className="col-span-2">
              ...
              <Input
                ...
                onChange={e => setNewDoctor(p => ({ ...p, institution: e.target.value }))}
